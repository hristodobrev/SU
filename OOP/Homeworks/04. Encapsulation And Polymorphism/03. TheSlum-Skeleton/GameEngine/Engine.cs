namespace TheSlum.GameEngine
{
    ...
    public class Engine
    {
        ...
        protected virtual void CreateCharacter(string[] inputParams)
        {
            ...
            {
                case "mage":
                    this.characterList.Add(new Mage(inputParams[2],
                        int.Parse(inputParams[3]),
                        int.Parse(inputParams[4]),
                        inputParams[5] == "Red" ? Team.Red : Team.Blue
                        ));
                    break;
                case "warrior":
                    this.characterList.Add(new Warrior(inputParams[2],
                        int.Parse(inputParams[3]),
                        int.Parse(inputParams[4]),
                        inputParams[5] == "Red" ? Team.Red : Team.Blue
                        ));
                    break;
                case "healer":
                    this.characterList.Add(new Healer(inputParams[2],
                        int.Parse(inputParams[3]),
                        int.Parse(inputParams[4]),
                        inputParams[5] == "Red" ? Team.Red : Team.Blue
                        ));
